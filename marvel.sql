...
-- The cinema is showing 'Batman Begins',
--  but Batman is DC, not Marvel! Delete the entry from the 'movies' table.
...
-- 8.  The cinema has just heard that they will be holding an exclusive midnight showing of 'Avengers:
--  Infinity War'!! Create a new entry in the 'movies' table to reflect this.
...
DELETE FROM people WHERE name ='' OR name ='';
SELECT * FROM people;
